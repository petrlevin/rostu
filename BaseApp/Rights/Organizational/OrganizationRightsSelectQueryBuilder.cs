...
{
    internal class OrganizationRightsSelectQueryBuilder : Platform.Dal.QueryBuilders.SelectQueryBuilder
    {
        ...
        protected OrganizationRightsSelectQueryBuilder(IEntity entity, List<string> fields)
            : base(entity, fields)
        {
    ...
    internal class OrganizationRightsSelectQueryBuilder<TImplementation> : OrganizationRightsSelectQueryBuilder where TImplementation : ImplementationRevert, new()
    {
        ...
        public OrganizationRightsSelectQueryBuilder(IEntity entity, int? itemId,
        ...
        public OrganizationRightsSelectQueryBuilder(IEntity entity, string captionValue,
                                  IOrganizationRightData rights, Dictionary<string, object> fromValues)
        ...
        public OrganizationRightsSelectQueryBuilder(IEntity entity, int[] itemIds,
                                  IOrganizationRightData rights)
        ...
        private OrganizationRightsSelectQueryBuilder(IEntity entity, int[] itemIds,
        ...
        private OrganizationRightsSelectQueryBuilder(IEntity entity,
