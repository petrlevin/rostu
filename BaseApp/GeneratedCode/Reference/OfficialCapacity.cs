...
namespace BaseApp.Reference
{
	...
	/// Должности
	/// </summary>
	public partial class OfficialCapacity : ReferenceEntity, IHasRefStatus      
	{
		...
		public class EntityIdRegistrator:IBeforeAplicationStart
		{
			...
			public void Execute()
			{
				Platform.BusinessLogic.EntityIds.Add(GetType().DeclaringType,-1946157024);
			}
		}
