...
{
    partial class ConsolidatedExpenditure
    {
        ...
        private string BuildBaseFilter(ConsolidatedExpenditure_BaseFilter filter, string prefix)
        {
            bool hasRule = false;
            ...
            {
                var ids = filter.ExpenseObligationType.Select(r => r.Id).ToArray();
