...
namespace Sbor.Reports.Tablepart
{
	...
	/// Правила фильтрации
	/// </summary>
	public partial class BudgetExpenseStructure_BaseFilter : TablePartEntity      
	{
		...
		/// Типы РО
		/// </summary>
		private ICollection<Sbor.Reports.Tablepart.BudgetExpenseStructure_BaseFilter_ExpenseObligationType> _tpExpenseObligationTypes; 
        /// <summary>
        /// Типы РО
        /// </summary>
        [JsonIgnoreForException]
		public virtual ICollection<Sbor.Reports.Tablepart.BudgetExpenseStructure_BaseFilter_ExpenseObligationType> ExpenseObligationTypes 
		{
			get{ return _tpExpenseObligationTypes ?? (_tpExpenseObligationTypes = new List<Sbor.Reports.Tablepart.BudgetExpenseStructure_BaseFilter_ExpenseObligationType>()); } 
			set{ _tpExpenseObligationTypes = value; }
		}

			private ICollection<Sbor.Reports.Tablepart.BudgetExpenseStructure_BaseFilter_ExpenseObligationType> _BudgetExpenseStructure_BaseFilter_ExpenseObligationType; 
        /// <summary>
        /// Ссылка на владельца
        /// </summary>
        [JsonIgnoreForException]
		public virtual ICollection<Sbor.Reports.Tablepart.BudgetExpenseStructure_BaseFilter_ExpenseObligationType> BudgetExpenseStructure_BaseFilter_ExpenseObligationType 
		{
			get{ return _BudgetExpenseStructure_BaseFilter_ExpenseObligationType ?? (_BudgetExpenseStructure_BaseFilter_ExpenseObligationType = new List<Sbor.Reports.Tablepart.BudgetExpenseStructure_BaseFilter_ExpenseObligationType>()); } 
			set{ _BudgetExpenseStructure_BaseFilter_ExpenseObligationType = value; }
		}
...
private ICollection<Sbor.Reference.FinanceSource> _mlFinanceSource; 
		...
		/// </summary>
		public BudgetExpenseStructure_BaseFilter()
		{
		}
		...
		public class EntityIdRegistrator:IBeforeAplicationStart
		{
			...
			public void Execute()
			{
				Platform.BusinessLogic.EntityIds.Add(GetType().DeclaringType,-1207959400);
			}
		}
