...
namespace Sbor.Reports.Tablepart
{
	...
	/// </summary>
	public partial class BudgetExpenseStructure_CustomFilter : TablePartEntity      
	{
	    ...
	    /// Колонка
	    /// </summary>
		public virtual Sbor.Reports.Tablepart.BudgetExpenseStructure_CustomColumn Master{get; set;}
		...
		/// Типы РО
		/// </summary>
		private ICollection<Sbor.Reports.Tablepart.BudgetExpenseStructure_CustomFilter_ExpenseObligationType> _tpExpenseObligationTypes; 
        /// <summary>
        /// Типы РО
        /// </summary>
        [JsonIgnoreForException]
		public virtual ICollection<Sbor.Reports.Tablepart.BudgetExpenseStructure_CustomFilter_ExpenseObligationType> ExpenseObligationTypes 
		{
			get{ return _tpExpenseObligationTypes ?? (_tpExpenseObligationTypes = new List<Sbor.Reports.Tablepart.BudgetExpenseStructure_CustomFilter_ExpenseObligationType>()); } 
			set{ _tpExpenseObligationTypes = value; }
		}
		...
		public byte? IdFilterFieldType_BranchCode{get; set;}
			...
			private ICollection<Sbor.Reports.Tablepart.BudgetExpenseStructure_CustomFilter_ExpenseObligationType> _BudgetExpenseStructure_CustomFilter_ExpenseObligationType; 
        /// <summary>
        /// Ссылка на владельца
        /// </summary>
        [JsonIgnoreForException]
		public virtual ICollection<Sbor.Reports.Tablepart.BudgetExpenseStructure_CustomFilter_ExpenseObligationType> BudgetExpenseStructure_CustomFilter_ExpenseObligationType 
		{
			get{ return _BudgetExpenseStructure_CustomFilter_ExpenseObligationType ?? (_BudgetExpenseStructure_CustomFilter_ExpenseObligationType = new List<Sbor.Reports.Tablepart.BudgetExpenseStructure_CustomFilter_ExpenseObligationType>()); } 
			set{ _BudgetExpenseStructure_CustomFilter_ExpenseObligationType = value; }
		}
...
private ICollection<Sbor.Reference.FinanceSource> _mlFinanceSource; 
		...
		/// </summary>
		public BudgetExpenseStructure_CustomFilter()
		{
		}
		...
		public class EntityIdRegistrator:IBeforeAplicationStart
		{
			...
			public void Execute()
			{
				Platform.BusinessLogic.EntityIds.Add(GetType().DeclaringType,-1207959382);
			}
		}
