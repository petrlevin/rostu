...
namespace Sbor.Reports.Report
{
	...
	/// </summary>
	public partial class GoalTargetsOfProgramSbp : ReportEntity      
	{
		...
		/// </summary>
		public GoalTargetsOfProgramSbp()
		{
		}
		...
		{
			get { return "Целевые показатели ведомственной целевой программы"; }
		}
		...
		public class EntityIdRegistrator:IBeforeAplicationStart
		{
			...
			public void Execute()
			{
				Platform.BusinessLogic.EntityIds.Add(GetType().DeclaringType,-1543503629);
			}
		}
