...
namespace Sbor.Reports.Report
{
	...
	/// </summary>
	public partial class NeedForTheProvisionOfActivitySbpWithinTheStateProgram : ReportEntity      
	{
		...
		/// </summary>
		public NeedForTheProvisionOfActivitySbpWithinTheStateProgram()
		{
		}
		...
		{
			get { return "Потребность в оказании услуг (выполнении работ) учреждениями в рамках государственной программы"; }
		}
		...
		public class EntityIdRegistrator:IBeforeAplicationStart
		{
			...
			public void Execute()
			{
				Platform.BusinessLogic.EntityIds.Add(GetType().DeclaringType,-1543503522);
			}
		}
