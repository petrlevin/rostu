/**
* @class App.events.GoalTargetsOfProgramSbp
* Обработчик клиентских событий сущности Отчет "Целевые показатели ВЦП"
*/
Ext.define('App.events.GoalTargetsOfProgramSbp', {
