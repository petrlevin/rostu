/**
* @class App.events.PublicInstitutionEstimate_ActivityAUBU
* Обработчик клиентских событий ТЧ "Мероприятия АУ/БУ"
*/
Ext.define('App.events.PublicInstitutionEstimate_ActivityAUBU', {
    ...
    onDataget: function () {
        ...
        this.getField('idActivityType').clearInvalid();
    ...
    setContingentAndIndicator: function (activity) {
        ...
        this.docService.getDefault_Activity(owner, activity, cont, true, this.onLoadActivity2, this);
    },
    ...
    onLoadActivityType: function(result) {
        ...
        this.getField('idActivityType').setValue(activityType.id, activityType.caption);
    },
