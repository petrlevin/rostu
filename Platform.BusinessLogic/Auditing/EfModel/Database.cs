...
// 
//     Configuration file:     "Platform.Web\Web.config"
//     Connection String Name: "AuditDBConnectionString"
//     Connection String:      "Data Source=.;Initial Catalog=platform3_Audit;Integrated Security=false;User=bis;password=**zapped**;"
...
namespace Platform.BusinessLogic.Auditing.EfModel
{
    ...
    public class AuditDataContext : DbContext, IAuditDataContext
    {
        ...
        public AuditDataContext()
            : base(AuditConnectionString.Get())
        {
        }
