	...
	public class OfItemsTests
    {
        ...
        public void StrategyShouldCallCreateSelectAndGetData()
        {
            ...
            IBaseFactoryElement<IList<SomeMetadata>> factoryElement =
                new OfItems<SomeMetadata, IDictionary<string, object>>(strategyMock,"idOfOther");



            strategyMock.Expect(s => s.CreateSelect(10, "idOfOther", "SomeMetadata")).Return(null);
            ...
            strategyMock.AssertWasCalled(s => s.CreateSelect(10, "idOfOther", "SomeMetadata"));
        ...
        public void CreateByIdUseBaseStrategy()
        {
            ...
            strategyMock.Stub(s => s.CreateSelect(1, "idOfOther", "SomeMetadata")).Return(selectMock1);
            strategyMock.Stub(s => s.CreateSelect(2, "idOfOther", "SomeMetadata")).Return(selectMock2);
            ...
            strategyMock.AssertWasCalled(s => s.CreateSelect(1, "idOfOther", "SomeMetadata"));
