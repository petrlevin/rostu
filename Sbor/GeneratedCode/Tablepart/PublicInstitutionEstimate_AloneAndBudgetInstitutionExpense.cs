...
namespace Sbor.Tablepart
{
	...
	/// </summary>
	public partial class PublicInstitutionEstimate_AloneAndBudgetInstitutionExpense : TablePartEntity      
	{
		...
		/// </summary>
		public PublicInstitutionEstimate_AloneAndBudgetInstitutionExpense()
		{
		}
		...
		{
			get { return "ТЧ «Расходы автономных и бюджетных учреждений»"; }
		}
		...
		public class EntityIdRegistrator:IBeforeAplicationStart
		{
			...
			public void Execute()
			{
				Platform.BusinessLogic.EntityIds.Add(GetType().DeclaringType,-1207959513);
			}
		}
