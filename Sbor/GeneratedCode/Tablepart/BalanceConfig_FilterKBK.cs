...
namespace Sbor.Tablepart
{
	...
	/// Фильтры КБК
	/// </summary>
	public partial class BalanceConfig_FilterKBK : TablePartEntity      
	{
		...
		/// </summary>
		public BalanceConfig_FilterKBK()
		{
		}
		...
		public class EntityIdRegistrator:IBeforeAplicationStart
		{
			...
			public void Execute()
			{
				Platform.BusinessLogic.EntityIds.Add(GetType().DeclaringType,-2013265301);
			}
		}
