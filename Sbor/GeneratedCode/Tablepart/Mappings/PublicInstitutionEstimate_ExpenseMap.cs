...
{
    /// <summary>
    /// Класс описывающий маппинг для сущности PublicInstitutionEstimate_Expense
    /// </summary>
	public class PublicInstitutionEstimate_ExpenseMap : EntityTypeConfiguration<PublicInstitutionEstimate_Expense>
    {
        /// <summary>
        /// Дефолтный конструктор
        /// </summary>
		public PublicInstitutionEstimate_ExpenseMap()
        {
            // Primary Key
            this.HasKey(t => t.Id);
            ...
            this.ToTable("PublicInstitutionEstimate_Expense", "tp");
			...
			this.HasRequired(t => t.Master).WithMany(t => t.PublicInstitutionEstimate_Expense).HasForeignKey(d => d.IdMaster);
