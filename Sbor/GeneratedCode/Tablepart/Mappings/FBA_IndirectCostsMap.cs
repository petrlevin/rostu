...
{
    /// <summary>
    /// Класс описывающий маппинг для сущности FBA_IndirectCosts
    /// </summary>
	public class FBA_IndirectCostsMap : EntityTypeConfiguration<FBA_IndirectCosts>
    {
        /// <summary>
        /// Дефолтный конструктор
        /// </summary>
		public FBA_IndirectCostsMap()
        {
            // Primary Key
            this.HasKey(t => t.Id);
            ...
            this.ToTable("FBA_IndirectCosts", "tp");
            ...
            // Relationships
			this.HasRequired(t => t.Owner).WithMany(t => t.IndirectCosts).HasForeignKey(d => d.IdOwner);
			this.HasRequired(t => t.Master).WithMany(t => t.FBA_IndirectCosts).HasForeignKey(d => d.IdMaster);
