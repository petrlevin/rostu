...
{
    /// <summary>
    /// Класс описывающий маппинг для сущности StateProgram_SystemGoalElement
    /// </summary>
	public class StateProgram_SystemGoalElementMap : EntityTypeConfiguration<StateProgram_SystemGoalElement>
    {
        /// <summary>
        /// Дефолтный конструктор
        /// </summary>
		public StateProgram_SystemGoalElementMap()
        {
            // Primary Key
            this.HasKey(t => t.Id);
            ...
            this.ToTable("StateProgram_SystemGoalElement", "tp");
