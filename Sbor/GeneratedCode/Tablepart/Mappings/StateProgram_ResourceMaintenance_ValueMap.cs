...
{
    /// <summary>
    /// Класс описывающий маппинг для сущности StateProgram_ResourceMaintenance_Value
    /// </summary>
	public class StateProgram_ResourceMaintenance_ValueMap : EntityTypeConfiguration<StateProgram_ResourceMaintenance_Value>
    {
        /// <summary>
        /// Дефолтный конструктор
        /// </summary>
		public StateProgram_ResourceMaintenance_ValueMap()
        {
            // Primary Key
            this.HasKey(t => t.Id);
            ...
            this.ToTable("StateProgram_ResourceMaintenance_Value", "tp");
			...
			this.HasRequired(t => t.Master).WithMany(t => t.StateProgram_ResourceMaintenance_Value).HasForeignKey(d => d.IdMaster);
