...
{
    /// <summary>
    /// Класс описывающий маппинг для сущности LongTermGoalProgram_SystemGoalElement
    /// </summary>
	public class LongTermGoalProgram_SystemGoalElementMap : EntityTypeConfiguration<LongTermGoalProgram_SystemGoalElement>
    {
        /// <summary>
        /// Дефолтный конструктор
        /// </summary>
		public LongTermGoalProgram_SystemGoalElementMap()
        {
            // Primary Key
            this.HasKey(t => t.Id);
            ...
            this.ToTable("LongTermGoalProgram_SystemGoalElement", "tp");
