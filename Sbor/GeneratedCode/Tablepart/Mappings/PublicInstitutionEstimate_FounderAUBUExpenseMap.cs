...
{
    /// <summary>
    /// Класс описывающий маппинг для сущности PublicInstitutionEstimate_FounderAUBUExpense
    /// </summary>
	public class PublicInstitutionEstimate_FounderAUBUExpenseMap : EntityTypeConfiguration<PublicInstitutionEstimate_FounderAUBUExpense>
    {
        /// <summary>
        /// Дефолтный конструктор
        /// </summary>
		public PublicInstitutionEstimate_FounderAUBUExpenseMap()
        {
            // Primary Key
            this.HasKey(t => t.Id);
            ...
            this.ToTable("PublicInstitutionEstimate_FounderAUBUExpense", "tp");
			...
			this.Property(t => t.IsAUBU).HasColumnName("isAUBU");
			...
			this.Property(t => t.AdditionalPFG1).HasPrecision(20,2).HasColumnName("AdditionalPFG1");
            ...
            // Relationships
			this.HasRequired(t => t.Owner).WithMany(t => t.FounderAUBUExpenses).HasForeignKey(d => d.IdOwner);
			this.HasRequired(t => t.Master).WithMany(t => t.PublicInstitutionEstimate_FounderAUBUExpense).HasForeignKey(d => d.IdMaster);
