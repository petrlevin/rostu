...
{
    /// <summary>
    /// Класс описывающий маппинг для сущности SBP_Blank
    /// </summary>
	public class SBP_BlankMap : EntityTypeConfiguration<SBP_Blank>
    {
        /// <summary>
		...
		public SBP_BlankMap()
        {
            ...
            // Relationships
			this.HasRequired(t => t.Owner).WithMany(t => t.SBP_Blank).HasForeignKey(d => d.IdOwner);
