...
{
    /// <summary>
    /// Класс описывающий маппинг для сущности LongTermGoalProgram_Activity_Value
    /// </summary>
	public class LongTermGoalProgram_Activity_ValueMap : EntityTypeConfiguration<LongTermGoalProgram_Activity_Value>
    {
        /// <summary>
        /// Дефолтный конструктор
        /// </summary>
		public LongTermGoalProgram_Activity_ValueMap()
        {
            // Primary Key
            this.HasKey(t => t.Id);
            ...
            this.ToTable("LongTermGoalProgram_Activity_Value", "tp");
			...
			this.HasRequired(t => t.Master).WithMany(t => t.LongTermGoalProgram_Activity_Value).HasForeignKey(d => d.IdMaster);
