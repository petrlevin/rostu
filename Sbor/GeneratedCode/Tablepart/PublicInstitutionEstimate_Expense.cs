...
namespace Sbor.Tablepart
{
	...
	/// ТЧ «Расходы»
	/// </summary>
	public partial class PublicInstitutionEstimate_Expense : TablePartEntity      
	{
	    ...
	    /// Мероприятие
	    /// </summary>
		public virtual Sbor.Tablepart.PublicInstitutionEstimate_Activity Master{get; set;}
		...
		/// </summary>
		public PublicInstitutionEstimate_Expense()
		{
		}
		...
		public class EntityIdRegistrator:IBeforeAplicationStart
		{
			...
			public void Execute()
			{
				Platform.BusinessLogic.EntityIds.Add(GetType().DeclaringType,-1207959521);
			}
		}
