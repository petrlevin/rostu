...
namespace Sbor.Tablepart
{
	...
	/// </summary>
	public partial class PublicInstitutionEstimate_IndirectExpenses : TablePartEntity      
	{
		...
		/// </summary>
		public PublicInstitutionEstimate_IndirectExpenses()
		{
		}
		...
		{
			get { return "ТЧ «Косвенные расходы»"; }
		}
		...
		public class EntityIdRegistrator:IBeforeAplicationStart
		{
			...
			public void Execute()
			{
				Platform.BusinessLogic.EntityIds.Add(GetType().DeclaringType,-1207959517);
			}
		}
