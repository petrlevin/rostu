...
namespace Sbor.Tablepart
{
	...
	/// </summary>
	public partial class LimitBudgetAllocations_ControlRelation : TablePartEntity      
	{
		...
		/// Разность, руб.
		/// </summary>
		public decimal? DiffAllocations{get; set;}

		/// <summary>
		/// Нераспределенный остаток, руб.
		/// </summary>
		public decimal? UnallocatedAllocations{get; set;}

		/// <summary>
		/// Сумма документа, руб.
		/// </summary>
		public decimal? TotalDocumentAllocations{get; set;}

		/// <summary>
		/// Распределено, руб.
		/// </summary>
		public decimal? AllocatedAllocations{get; set;}

		/// <summary>
		/// в т.ч. по учреждению, руб.
		/// </summary>
		public decimal? WithCompanyAllocations{get; set;}

		/// <summary>
		/// План ГРБС, руб.
		/// </summary>
		public decimal? PlanGRBSAllocations{get; set;}
		...
		/// </summary>
		public LimitBudgetAllocations_ControlRelation()
		{
		}
		...
		{
			get { return "Контрольные соотношения"; }
		}
		...
		public class EntityIdRegistrator:IBeforeAplicationStart
		{
			...
			public void Execute()
			{
				Platform.BusinessLogic.EntityIds.Add(GetType().DeclaringType,-1207959528);
			}
		}
