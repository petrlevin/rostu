...
namespace Sbor.Tablepart
{
	...
	/// Соисполнители
	/// </summary>
	public partial class LongTermGoalProgram_CoExecutor : TablePartEntity      
	{
		...
		/// </summary>
		public LongTermGoalProgram_CoExecutor()
		{
		}
		...
		public class EntityIdRegistrator:IBeforeAplicationStart
		{
			...
			public void Execute()
			{
				Platform.BusinessLogic.EntityIds.Add(GetType().DeclaringType,-1543503786);
			}
		}
