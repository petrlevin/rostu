...
namespace Sbor.Tablepart
{
	...
	/// </summary>
	public partial class SBP_BlankHistory : TablePartEntity      
	{
		...
		public virtual BaseApp.Reference.Budget Budget{get; set;}
			...
			private ICollection<Sbor.Tablepart.ActivityOfSBP_SBPBlankActual> _ActivityOfSBP_SBPBlankActual; 
        /// <summary>
        /// Актуальный бланк формирования
        /// </summary>
        [JsonIgnoreForException]
		public virtual ICollection<Sbor.Tablepart.ActivityOfSBP_SBPBlankActual> ActivityOfSBP_SBPBlankActual 
		{
			get{ return _ActivityOfSBP_SBPBlankActual ?? (_ActivityOfSBP_SBPBlankActual = new List<Sbor.Tablepart.ActivityOfSBP_SBPBlankActual>()); } 
			set{ _ActivityOfSBP_SBPBlankActual = value; }
		}
		...
		{
			get { return "История создания бланков доведения и формирования"; }
		}
		...
		public class EntityIdRegistrator:IBeforeAplicationStart
		{
			...
			public void Execute()
			{
				Platform.BusinessLogic.EntityIds.Add(GetType().DeclaringType,-1543503510);
			}
		}
