...
namespace Sbor.Tablepart
{
	...
	/// </summary>
	public partial class LongTermGoalProgram_Activity_Value : TablePartEntity      
	{
		...
		/// </summary>
		public LongTermGoalProgram_Activity_Value()
		{
		}
		...
		{
			get { return "Мероприятия - значения объемов"; }
		}
		...
		public class EntityIdRegistrator:IBeforeAplicationStart
		{
			...
			public void Execute()
			{
				Platform.BusinessLogic.EntityIds.Add(GetType().DeclaringType,-1543503758);
			}
		}
