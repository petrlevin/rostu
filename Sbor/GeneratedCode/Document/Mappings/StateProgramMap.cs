...
{
    /// <summary>
    /// Класс описывающий маппинг для сущности StateProgram
    /// </summary>
	public class StateProgramMap : EntityTypeConfiguration<StateProgram>
    {
        /// <summary>
		...
		public StateProgramMap()
        {
			...
			this.HasOptional(t => t.MasterDoc).WithMany(t => t.ChildrenByidMasterDoc).HasForeignKey(d => d.IdMasterDoc);
