...
{
    /// <summary>
    /// Класс описывающий маппинг для сущности ActivityOfSBP
    /// </summary>
	public class ActivityOfSBPMap : EntityTypeConfiguration<ActivityOfSBP>
    {
        /// <summary>
        /// Дефолтный конструктор
        /// </summary>
		public ActivityOfSBPMap()
        {
            // Primary Key
            this.HasKey(t => t.Id);
            ...
            this.ToTable("ActivityOfSBP", "doc");
			...
			this.Property(t => t.IdMasterDoc).HasColumnName("idMasterDoc");
			...
			this.HasOptional(t => t.MasterDoc).WithMany().HasForeignKey(d => d.IdMasterDoc);
