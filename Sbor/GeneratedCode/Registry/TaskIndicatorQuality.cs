...
namespace Sbor.Registry
{
	...
	/// </summary>
	public partial class TaskIndicatorQuality : RegistryEntity  , IHasCommonRegistrator , IHasCommonTerminator  , IRegistryWithOperation , IRegistryWithTermOperation
	{
		...
		/// Показатель качества
		/// </summary>
		public int IdIndicatorActivity_Quality{get; set;}
        /// <summary>
	    /// Показатель качества
	    /// </summary>
		public virtual Sbor.Reference.IndicatorActivity IndicatorActivity_Quality{get; set;}
		...
		{
			get { return "Показатели качества задач"; }
		}
		...
		public class EntityIdRegistrator:IBeforeAplicationStart
		{
			...
			public void Execute()
			{
				Platform.BusinessLogic.EntityIds.Add(GetType().DeclaringType,-1543503769);
			}
		}
