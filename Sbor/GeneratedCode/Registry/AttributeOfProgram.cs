...
namespace Sbor.Registry
{
	...
	/// Атрибуты программы
	/// </summary>
	public partial class AttributeOfProgram : RegistryEntity  , IHasCommonRegistrator , IHasCommonTerminator  , IRegistryWithOperation , IRegistryWithTermOperation
	{
		...
		/// Основная цель
		/// </summary>
		public int IdGoalSystemElement{get; set;}
        /// <summary>
	    /// Основная цель
	    /// </summary>
		public virtual Sbor.Registry.SystemGoalElement GoalSystemElement{get; set;}
		

		/// <summary>
		/// Вышестоящая программа
		/// </summary>
		public int? IdParent{get; set;}
        /// <summary>
	    /// Вышестоящая программа
	    /// </summary>
		public virtual Sbor.Registry.Program Parent{get; set;}
		...
		public class EntityIdRegistrator:IBeforeAplicationStart
		{
			...
			public void Execute()
			{
				Platform.BusinessLogic.EntityIds.Add(GetType().DeclaringType,-1543503801);
			}
		}
