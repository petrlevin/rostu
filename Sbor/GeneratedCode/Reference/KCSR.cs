...
namespace Sbor.Reference
{
	...
	/// КЦСР
	/// </summary>
	public partial class KCSR : ReferenceEntity, IHasRefStatus , IVersioning   , IHierarhy  
	{
	    ...
	    /// Вышестоящий
	    /// </summary>
		public virtual Sbor.Reference.KCSR Parent{get; set;}
		private ICollection<Sbor.Reference.KCSR> _idParent; 
        /// <summary>
        /// Вышестоящий
        /// </summary>
        [JsonIgnoreForException]
		public virtual ICollection<Sbor.Reference.KCSR> ChildrenByidParent 
		{
			get{ return _idParent ?? (_idParent = new List<Sbor.Reference.KCSR>()); } 
			set{ _idParent = value; }
		}
	    ...
	    /// Cсылка на корень
	    /// </summary>
		public virtual Sbor.Reference.KCSR Root{get; set;}
		private ICollection<Sbor.Reference.KCSR> _idRoot; 
        /// <summary>
        /// Cсылка на корень
        /// </summary>
        [JsonIgnoreForException]
		public virtual ICollection<Sbor.Reference.KCSR> ChildrenByidRoot 
		{
			get{ return _idRoot ?? (_idRoot = new List<Sbor.Reference.KCSR>()); } 
			set{ _idRoot = value; }
		}
		...
		public class EntityIdRegistrator:IBeforeAplicationStart
		{
			...
			public void Execute()
			{
				Platform.BusinessLogic.EntityIds.Add(GetType().DeclaringType,-1543503738);
			}
		}
