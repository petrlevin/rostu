...
namespace Sbor.Reference
{
	...
	/// ДКР
	/// </summary>
	public partial class DKR : ReferenceEntity, IHasRefStatus , IVersioning   , IHierarhy  
	{
	    ...
	    /// Вышестоящий
	    /// </summary>
		public virtual Sbor.Reference.DKR Parent{get; set;}
		private ICollection<Sbor.Reference.DKR> _idParent; 
        /// <summary>
        /// Вышестоящий
        /// </summary>
        [JsonIgnoreForException]
		public virtual ICollection<Sbor.Reference.DKR> ChildrenByidParent 
		{
			get{ return _idParent ?? (_idParent = new List<Sbor.Reference.DKR>()); } 
			set{ _idParent = value; }
		}
	    ...
	    /// Cсылка на корень
	    /// </summary>
		public virtual Sbor.Reference.DKR Root{get; set;}
		private ICollection<Sbor.Reference.DKR> _idRoot; 
        /// <summary>
        /// Cсылка на корень
        /// </summary>
        [JsonIgnoreForException]
		public virtual ICollection<Sbor.Reference.DKR> ChildrenByidRoot 
		{
			get{ return _idRoot ?? (_idRoot = new List<Sbor.Reference.DKR>()); } 
			set{ _idRoot = value; }
		}
		...
		public class EntityIdRegistrator:IBeforeAplicationStart
		{
			...
			public void Execute()
			{
				Platform.BusinessLogic.EntityIds.Add(GetType().DeclaringType,-1543503740);
			}
		}
