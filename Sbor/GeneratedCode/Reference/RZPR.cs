...
namespace Sbor.Reference
{
	...
	/// РзПР
	/// </summary>
	public partial class RZPR : ReferenceEntity, IHasRefStatus , IVersioning   , IHierarhy  
	{
	    ...
	    /// Вышестоящий
	    /// </summary>
		public virtual Sbor.Reference.RZPR Parent{get; set;}
		private ICollection<Sbor.Reference.RZPR> _idParent; 
        /// <summary>
        /// Вышестоящий
        /// </summary>
        [JsonIgnoreForException]
		public virtual ICollection<Sbor.Reference.RZPR> ChildrenByidParent 
		{
			get{ return _idParent ?? (_idParent = new List<Sbor.Reference.RZPR>()); } 
			set{ _idParent = value; }
		}
	    ...
	    /// Cсылка на корень
	    /// </summary>
		public virtual Sbor.Reference.RZPR Root{get; set;}
		private ICollection<Sbor.Reference.RZPR> _idRoot; 
        /// <summary>
        /// Cсылка на корень
        /// </summary>
        [JsonIgnoreForException]
		public virtual ICollection<Sbor.Reference.RZPR> ChildrenByidRoot 
		{
			get{ return _idRoot ?? (_idRoot = new List<Sbor.Reference.RZPR>()); } 
			set{ _idRoot = value; }
		}
		...
		public class EntityIdRegistrator:IBeforeAplicationStart
		{
			...
			public void Execute()
			{
				Platform.BusinessLogic.EntityIds.Add(GetType().DeclaringType,-1543503737);
			}
		}
