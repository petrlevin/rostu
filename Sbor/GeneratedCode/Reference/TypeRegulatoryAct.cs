...
namespace Sbor.Reference
{
	...
	/// Виды НПА
	/// </summary>
	public partial class TypeRegulatoryAct : ReferenceEntity, IHasRefStatus      
	{
		...
		public class EntityIdRegistrator:IBeforeAplicationStart
		{
			...
			public void Execute()
			{
				Platform.BusinessLogic.EntityIds.Add(GetType().DeclaringType,-2013265887);
			}
		}
