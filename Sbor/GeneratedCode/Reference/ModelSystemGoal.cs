...
namespace Sbor.Reference
{
	...
	/// Модель СЦ
	/// </summary>
	public partial class ModelSystemGoal : ReferenceEntity, IHasRefStatus    , IHierarhy  
	{
	    ...
	    /// Вышестоящий
	    /// </summary>
		public virtual Sbor.Reference.ModelSystemGoal Parent{get; set;}
		private ICollection<Sbor.Reference.ModelSystemGoal> _idParent; 
        /// <summary>
        /// Вышестоящий
        /// </summary>
        [JsonIgnoreForException]
		public virtual ICollection<Sbor.Reference.ModelSystemGoal> ChildrenByidParent 
		{
			get{ return _idParent ?? (_idParent = new List<Sbor.Reference.ModelSystemGoal>()); } 
			set{ _idParent = value; }
		}
		...
		public class EntityIdRegistrator:IBeforeAplicationStart
		{
			...
			public void Execute()
			{
				Platform.BusinessLogic.EntityIds.Add(GetType().DeclaringType,-2013265867);
			}
		}
