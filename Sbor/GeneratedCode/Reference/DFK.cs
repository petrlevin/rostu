...
namespace Sbor.Reference
{
	...
	/// ДФК
	/// </summary>
	public partial class DFK : ReferenceEntity, IHasRefStatus , IVersioning   , IHierarhy  
	{
	    ...
	    /// Вышестоящий
	    /// </summary>
		public virtual Sbor.Reference.DFK Parent{get; set;}
		private ICollection<Sbor.Reference.DFK> _idParent; 
        /// <summary>
        /// Вышестоящий
        /// </summary>
        [JsonIgnoreForException]
		public virtual ICollection<Sbor.Reference.DFK> ChildrenByidParent 
		{
			get{ return _idParent ?? (_idParent = new List<Sbor.Reference.DFK>()); } 
			set{ _idParent = value; }
		}
	    ...
	    /// Cсылка на корень
	    /// </summary>
		public virtual Sbor.Reference.DFK Root{get; set;}
		private ICollection<Sbor.Reference.DFK> _idRoot; 
        /// <summary>
        /// Cсылка на корень
        /// </summary>
        [JsonIgnoreForException]
		public virtual ICollection<Sbor.Reference.DFK> ChildrenByidRoot 
		{
			get{ return _idRoot ?? (_idRoot = new List<Sbor.Reference.DFK>()); } 
			set{ _idRoot = value; }
		}
		...
		public class EntityIdRegistrator:IBeforeAplicationStart
		{
			...
			public void Execute()
			{
				Platform.BusinessLogic.EntityIds.Add(GetType().DeclaringType,-1543503742);
			}
		}
