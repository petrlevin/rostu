...
namespace Sbor.Tablepart
{
	...
	public partial class PlanActivity_ActivityVolumeAUBU : TablePartEntity   
	{
        ...
        /// </summary>         
        [ControlInitial(InitialUNK = "0603/2", InitialCaption = "Проверка  периодов у объемов мероприятий")]
        ...
        public void Control_0603(DataContext context)
        {
            ...
            List<string> list = context.PlanActivity_ActivityVolumeAUBU.Where(w =>
