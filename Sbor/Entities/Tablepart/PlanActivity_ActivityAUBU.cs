...
namespace Sbor.Tablepart
{
	...
	/// Мероприятия АУ/БУ
	/// </summary>
    public partial class PlanActivity_ActivityAUBU : TablePartEntity, IPlanActivity_ActivityTps
	{
        ...
        /// </summary>         
        [ControlInitial(InitialUNK = "0628/2", InitialCaption = "Наличие удаляемого мероприятия в смете учреждения или в ПФХД", InitialManaged = true)]
        [Control(ControlType.Delete | ControlType.Update, Sequence.Before, ExecutionOrder = 10)]
        public void Control_0628(DataContext context, ControlType ct, PlanActivity_ActivityAUBU old)
        {
